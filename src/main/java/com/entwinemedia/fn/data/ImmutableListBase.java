...
/** Abstract base class for immutable list implementations. */
public abstract class ImmutableListBase<A> implements List<A>, Immutable {
  ...
  @Override public boolean addAll(int i, Collection<? extends A> as) {
    throw new UnsupportedOperationException();
  }
  ...
  @Override public A set(int i, A a) {
    throw new UnsupportedOperationException();
  }

  @Override public void add(int i, A a) {
    throw new UnsupportedOperationException();
  }

  @Override public A remove(int i) {
    throw new UnsupportedOperationException();
  }
}
